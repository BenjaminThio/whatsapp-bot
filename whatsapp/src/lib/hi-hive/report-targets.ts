...
import { reportSettings, type ReportSetting } from "../../../../shared/config/report-settings.js";
import { isWhitelisted } from "../../../../shared/hi-hive/scan-buffer-db.js";
import { loadCreds, getAllDocs } from "../../../../shared/hi-hive/creds.js";
import type { ReportStatus } from "../../../../shared/hi-hive/scan-status.js";
import { type Destination, includesStudent, includesStatus, scannedByHeader, isSilentChat } from "../../../../shared/hi-hive/destinations.js";

// The neutral half now lives in shared/hi-hive/destinations.ts; re-exported so
// existing callers keep one import.
export { type Destination, includesStudent, includesStatus, scannedByHeader, isSilentChat };
